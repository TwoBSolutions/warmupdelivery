<div ng-controller="CreatePedidosCtrl" ng-cloak>
    <div role="tabpanel" class='tabs-pedido'>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation">
                <a href="#enderecos" aria-controls="enderecos" role="tab" data-toggle="tab">
                    Endereço de entrega
                </a>
            </li>
            <li role="presentation">
        ...
        <div class="tab-content ">
                ...
                <table class="table table-hover datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class='profile_pic_min'>
                                <img src="{{ '/files/profiles/'.$user->foto }}" alt="">
                            </td>
                            <td>
                            ...
                            <td>
                                @if ($user->status)
                                <i class="fa fa-toggle-on sts_on">
                                </i>
                                Ativo
                                @else
                                <i class="fa fa-toggle-off sts_off">
                                </i>
                                Bloqueado
                                @endif
                            </td>
                            <td>
                                <!-- Single button --><button type="button" ng-click='addUserPedido({{$user->id}})' class="btn btn-success">
                                    <i class="fa fa-check">
                                    </i>
                                    Selecionar
                                </button>
                    ...
                    <tbody>
                        ...
                        <tr id='linha{{$produto->
                            ...
                            <td>
                                ...
                                <button  type="button" ng-click="addIten({{$produto->id}})" class="btn btn-sm btn-primary">
                                    <i class="fa fa-plus">
                                    </i>
                                    Adicionar
                                </button>
            ...
            <div role="tabpanel" class="tab-pane fade" id="enderecos">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr ng-repeat="(i, end) in pedido.user.enderecos">
                                ...
                                <td>
                                    <button type="button" ng-click="pedido.endereco = end" class="btn btn-sm btn-info">
                                        <i class="fa fa-check">
                                        </i>
                                    </button>
                                </td>
                ...
                <div class="panel panel-info">
                    ...
                    <button type="button" ng-click="pedido.endereco = {}" class="btn btn-sm btn-danger">
          ...
          <div class="form-group">
          	<label for="inputFormaPagamento" class="col-sm-2 control-label">Forma de Pagamento:</label>
          	<div class="col-sm-2">
          		<select name="formaPagamento" id="inputFormaPagamento" class="form-control" required="required">
          			<option value="MQN">Cartão Maquininha</option>
        ...
        <section class="panel">
            <div class="panel-body">
                <div class="invoice">
                    ...
                    <div class="form-group">
                        <label for="inputObser" class="col-sm-2 control-label">
                            Observação:
                        </label>
                        <div class="col-sm-10">
                        ...
                        <table class="table invoice-items">
                            <thead>
                                <tr class="h4 text-dark">
                                    <th id="cell-id"     class="text-semibold">
                                        #
                                    </th>
                                    <th id="cell-item"   class="text-semibold">
                                        Item
                                    </th>
                                    <th id="cell-desc"   class="text-semibold">
                                        Descrição
                                    </th>
                                    <th id="cell-price"  class="text-center text-semibold">
                                        Preço
                                    </th>
                                    <th id="cell-qty"    class="text-center text-semibold">
                                        Quantidade
                                    </th>
                            ...
                            <tbody>
                                <tr ng-repeat="(i, item) in pedido.itens" ng-cloak>
                                    ...
                                    <td class="text-center">
                                        <div ng-if='item.qtd >
                                            item.estoque' class="alert alert-warning">
                                            Faltam @{{item.qtd - item.estoque}} itens no estoque
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-btn">
                                                <button type="button" ng-click="removeItem(item.id)" class="btn  btn-danger">
                                                    <i class="fa fa-eraser">
                                                    </i>
                                                </button>
                                            </span>
                                            <input type='number' min="1" ng-change='itemUpdateQtd(item.id)' ng-model='item.qtd' class='form-control'/>
                                        </input>
                                    </div>
                                    <!-- /input-group --><td class="text-center">
                                        @{{(item.qtd * item.valor | currency: ' R$ ')}}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <table class="table h5 text-dark">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                R$
                                                <input type='text' ng-change='updateValuePedido()' ng-model='pedido.desconto' class='form-control'/>
                                            </input>
                                        </td>
                                    </tr>
                                    <tr class="h4">
            ...
            <div class="text-right mr-lg">
                <a  class="btn btn-default" ng-if='pedido.id_user && pedido.itens' ng-click="savePedido()">
                    <i class="fa fa-save">
                    </i>
                    Gravar Pedido
                </a>
                <a href="pages-invoice-print.html" target="_blank" class="btn btn-primary ml-sm">
                    <i class="fa fa-print">
                    </i>
                    Print
                </a>
